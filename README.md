...
Web Server: http://crdd.osdd.net/raghava/hemolytik/
...
Explore
Built-in Tools
Search and Browse: Users can search by peptide name, sequence, or specific properties, and browse by peptide function or erythrocyte source.

Similarity Search: Integrated BLAST tool to compare user-provided sequences against the database entries.

Assay Details: Each entry includes information on experimental conditions, such as the type of hemolytic assay and the percentage of hemolysis observed.
...
Hemolytic Data	Percentage hemolysis, hemolytic concentration (e.g., HC 
50
​
 ), and erythrocyte source
